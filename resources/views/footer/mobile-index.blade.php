    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
      <div class="card-body">
         <ul class="row__list" data-reactid="67">
            <li class="row__listt__item" data-reactid="68"><a href="/en-as/contact-service" target="_self" class="sub_item" data-reactid="69">Contact Simplified Woodcrafting</a></li>
